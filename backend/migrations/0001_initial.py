# Generated by Django 5.0.3 on 2024-04-25 18:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField()),
                ('activity_type', models.CharField(choices=[('put_away', 'Put Away'), ('pick', 'Pick'), ('receive', 'Receive'), ('transfer', 'Transfer'), ('adjustment', 'Adjustment'), ('cycle_count', 'Cycle Count'), ('replenishment', 'Replenishment'), ('other', 'Other')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ManyToManyField(to='backend.orderdetail')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.order')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.product')),
                ('to_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_location', to='backend.location')),
            ],
        ),
        migrations.AddField(
            model_name='shipment',
